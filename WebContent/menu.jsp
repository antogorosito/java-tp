			...
			<form class="form-bus" action="menu" method="post">
   				<div class="row">
        			<div class="col-md-4">
          				...
          				<button class="btn btn-primary " style="margin-right: 50px" type="submit" name="op" value="altaSocio">Ir</button>
        			</div>
        			<div class="col-md-4">
	          			<h2>Alta libro</h2>
          				<p>Realizar el registros de nuevos libros y ejemplares en la biblioteca. </p>
          				<button class="btn btn-primary " style="margin-right: 50px" type="submit" name="op" value="altaLibro">Ir</button>
        			</div>
        		   	<div class="col-md-4">
          				<h2>Alta Ejemplar</h2>
          				<p>Realizar el registro de nuevos ejemplares de libros en la biblioteca. </p>
          				<button class="btn btn-primary " style="margin-right: 50px" type="submit" name="op" value="altaEjemplar">Ir</button>
       				</div>    
      			</div>
   				...
   				<div class="row">
   					<div class="col-md-4">
          				...
          				<p>Imprimir los respectivos informes. </p>
          				 <button class="btn btn-primary " style="margin-right: 50px" type="submit" name="op" value="informes">Ir</button>
        			</div>
      				<div class="col-md-4">
          				<h2>Estado </h2>
			...
			<form class="form-bus" action="menu" method="post">
				<div class="row">
          			<div class="col-md-4">
          				...
          				<button class="btn btn-primary " style="margin-right: 50px" type="submit" name="op" value="pendiente">Ir</button>
       				</div>
        			<div class="col-md-4">
          				<h2>Consultas</h2>
          				<p>Realizar consultas sobre la disponibilidad de los libros. </p>
