    	...
    	<form class="form-prestamos" action="prestamos" method="post">
    		<label>Id socio:</label>
     		<input type="number" name="idSocio" required="required">
      		...
      		<button class="btn btn-info" style="margin-right: 50px" type="submit" name="op" value="Volver" formnovalidate>Volver</button>
	      	<%String msj=(String)request.getAttribute("errorPre");
  			if (msj != null) {%>
